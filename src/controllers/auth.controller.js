...
export const signup = async (req, res) => {
    try {
        const {username, email, password, name, bio, github, portfolio, linkedin, techstack} = req.body;
...
export const updateProfilePic = async (req, res) => {
    try {
        ...
        const updatedUser = await User.findByIdAndUpdate(req.user._id, {profilePic: result.secure_url}, {new: true}).select("-password");
