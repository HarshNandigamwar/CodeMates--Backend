...
import {checkAuth, signup, login, updateProfilePic, searchUsers, getUserById, followUnfollowUser, updateProfile, logout} from "../controllers/auth.controller.js";
import {protect} from "../middleware/auth.middleware.js";
import upload from "../middleware/multer.middleware.js";
import {getUserProfile, getSuggestedUsers} from "../controllers/user.controller.js";
